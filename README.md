...
| **Hands-on engineer** | [Pattern 06: Parity](./patterns/06-parity.md) then [Templates](./templates/README.md) | [Learning paths](./LEARNING-PATHS.md) |
...
| **[Patterns](./patterns/06-parity.md)** | Nine field-tested patterns with diagrams: [Parity](./patterns/06-parity.md), [Strangler-fig](./patterns/02-strangler-fig.md), [Taming stored procedures](./patterns/01-taming-stored-procedures.md), [Event-driven and saga](./patterns/03-event-driven-saga.md), [AI in workflows](./patterns/04-ai-in-workflows.md), [Cutover](./patterns/07-cutover.md), [Reliability under an LLM](./patterns/05-reliability-under-llm.md), plus the [Parity Harness deep-dive](./patterns/parity-harness-deepdive.md) |
| **[Templates](./templates/README.md)** | 12 copy-paste artifacts nobody else ships free and coherent: application inventory with 7R disposition, risk register, wave plan, cutover runbook, rollback plan, **parity report**, ADR, business case, characterization test plan, RACI, legacy knowledge map, dependency map |
...
| **[AI in modernization](./ai/README.md)** | The tool landscape (watsonx, AWS Transform, Moderne, Mechanical Orchard), the documented limits, and the signature method: **[legacy-code archaeology](./ai/legacy-archaeology.md)**, recovering intent from undocumented legacy code with AI agents under human sign-off |

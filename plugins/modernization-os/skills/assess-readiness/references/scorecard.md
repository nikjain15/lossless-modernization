...
**Amber:** internal ownership is intended but the vendor currently holds the design or the evidence. **Red:** the integrator owns the target design, the test evidence, or the only people who understand the new system. Birmingham: £19M became £144M+.

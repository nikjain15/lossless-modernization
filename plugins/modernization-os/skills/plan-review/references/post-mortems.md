...
**Cost:** roughly 900 wrongful prosecutions, roughly $1.3B (£1B+) in redress, decades of ruined lives.
...
**Cost:** roughly $24M (£19M) became roughly $180M+ (£144M+), estimated roughly $271M (£216.5M) by 2026. Contributed to the council declaring effective bankruptcy.
...
**Cost:** contributed to roughly $20B in fraud, plus a claims backlog crisis.

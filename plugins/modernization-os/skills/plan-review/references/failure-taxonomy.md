...
Handing away the capability you cannot buy back. Birmingham City Council went from roughly $24M (£19M) to roughly $180M+ (£144M+) on an over-customized ERP.

**Look for:** retained internal ownership of domain knowledge and the parity evidence, plus exit terms.

**Walking into it:**
- **The integrator owns the design or the evidence.** The vendor holds the target architecture or the test evidence, so the capability leaves when they do. Birmingham City Council: roughly $24M (£19M) became roughly $180M+ (£144M+).
